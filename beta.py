            ...
            for (objectID, centroid) in objects.items():
                ...
                # object on the output frame
                    ...
                    try:
                        ...
                        #velocity = deltaDistance/elap
                        #print(str(deltaDistance) +"/ "+ str(t.tm_sec) + "/ " + str(velocity));

                        #Vtot = (abs(deltaDistance))/t.tm_sec
                        
                        Vtot = float("{0:.2f}".format((abs(deltaDistance))/elapsed))
                        Vobj = float("{0:.2f}".format(Vtot - Vcar))
